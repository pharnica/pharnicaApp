...
const Checkout = () => {
  ...
  const { prescriptions, popPrescriptions } = usePrescriptionStore();
  ...
  return (
    <React.Fragment>
      <View className="flex-1 bg-gray-100 py-4 px-4 relative">
        <StatusBar
          animated
        ...
        <View className="w-full mb-3 flex flex-row items-center justify-between">
          <View className="flex flex-row items-center gap-3">
            <Pressable
            ...
            <Text className="text-lg font-PoppinsMedium">Checkout</Text>
          </View>
